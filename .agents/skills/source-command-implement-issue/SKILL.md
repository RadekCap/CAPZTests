---
name: "source-command-implement-issue"
description: "Analyze a GitHub issue and create a pull request that implements the fix"
---

# source-command-implement-issue

Use this skill when the user asks to run the migrated source command `implement-issue`.
...
3. **Analyze the issue**
   ...
   - Check AGENTS.md for repository-specific patterns and guidelines
...
8. **Implement the fix**
   - Follow repository patterns from AGENTS.md
...
9. **Run relevant tests**
    - Determine which tests to run based on the project:
      - Check AGENTS.md for test commands
...
10. **Format code**
    ...
    - Check AGENTS.md for formatting guidelines
...
15. **Post comment on the issue describing the implementation**
    ...
    - Format:
      ...
      Automated implementation via [Codex](https://Codex.com/Codex)
      EOF
      )"
      ```
...
- **Follow patterns**: Adhere to AGENTS.md guidelines and existing code patterns
...
- **Commit messages**: Descriptive, reference issue number, use `Codex Opus 4.6` in Co-Author
...
- [ ] Code follows repository patterns (AGENTS.md)
...
- [ ] Commit message uses `Codex Opus 4.6` in Co-Author
...
3. **Check AGENTS.md**: Follow project-specific patterns and conventions
