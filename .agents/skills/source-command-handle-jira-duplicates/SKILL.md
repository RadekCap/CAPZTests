---
name: "source-command-handle-jira-duplicates"
description: "Handle duplicate Jira subtasks by linking, renaming, and closing the old ones."
---

# source-command-handle-jira-duplicates

Use this skill when the user asks to run the migrated source command `handle-jira-duplicates`.
