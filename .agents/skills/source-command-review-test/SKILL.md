---
name: "source-command-review-test"
description: "Migrated source command `review-test`"
---

# source-command-review-test

Use this skill when the user asks to run the migrated source command `review-test`.
...
- Suggested fix aligned with AGENTS.md guidelines
