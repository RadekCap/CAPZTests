---
name: "source-command-prow-status"
description: "Migrated source command `prow-status`"
---

# source-command-prow-status

Use this skill when the user asks to run the migrated source command `prow-status`.
