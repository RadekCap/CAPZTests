...
2. **Identify affected documentation**:
   ...
   - `AGENTS.md` - Development guidelines, patterns, architecture
...
- Add to AGENTS.md test architecture
...
- Update AGENTS.md development commands
