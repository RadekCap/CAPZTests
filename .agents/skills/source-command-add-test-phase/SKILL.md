---
name: "source-command-add-test-phase"
description: "Migrated source command `add-test-phase`"
---

# source-command-add-test-phase

Use this skill when the user asks to run the migrated source command `add-test-phase`.
...
4. Suggest documentation updates:
   ...
   - AGENTS.md (add to test architecture section)
